...
pub(crate) const ROMIRA_CONTENT_ID: &'static str = "63fdfa40a6b1cce86529ebcf";
pub(crate) const PRTIMES_WP_BASE_URL: &'static str = "https://developers.prtimes.jp";
pub(crate) const PRTIMES_WP_AUTHOR_ID: u64 = 204642668;
pub(crate) const THUMBNAIL_NO_IMAGE_URL: &'static str =
