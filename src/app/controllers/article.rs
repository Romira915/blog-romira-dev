  ...
  "items": [
    {
      ...
      "author": {
        ...
        "profileImage": null,
        "biography": "<p>2021年にFictitiousを創業。前職のPetlassianではマーケティング責任者としてグローバル・マーケティ ングを担当し、オンライン販売モデルの構築・拡大に貢献</p>"
      },
      "categories": [
        {
...
pub(crate) async fn fetch_articles() -> Result<Articles, serde_json::Error> {
    ...
    serde_json::from_str::<Articles>(&response)

    // response.unwrap().json::<Articles>().await.unwrap().items
}
